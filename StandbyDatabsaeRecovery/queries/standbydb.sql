...
SELECT 'INPLAY.CASH_POSITION|' || TO_CHAR(MAX(BIZ_DATE), 'YYYY-MM-DD HH24:MI:SS')
FROM INPLAY.CASH_POSITION;

SELECT 'INPLAY.CASH_TRANSFER_HISTORY|' || TO_CHAR(MAX(TRANSFERDATE), 'YYYY-MM-DD HH24:MI:SS')
